<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="AprobarPedidosCDR.aspx.cs" Inherits="SantaNaturaNetworkV3.AprobarPedidosCDR" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">Pedidos CDR</h1>
    </section>
    <section class="content">
        ...
        <script src="js/AprobarPedidoCDR.js?v17"></script>
