<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Documentos.aspx.cs" Inherits="SantaNaturaNetworkV3.Documentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="height: 100vh; background-repeat: no-repeat">
        <div style="padding-top: 90px; margin-bottom: 20px">
            <h1 style="text-align: center; font-family: system-ui; font-size: 34px; font-style: normal; font-variant: normal; font-weight: 700; line-height: 26.4px; color: forestgreen">DOCUMENTOS
            </h1>
        </div>
                ...
                <ul id="menu-group-1" class="nav menu">
                    <li class="item-1 deeper parent " style="width: 95%; margin-left: auto; margin-right: auto;">
                        <a data-toggle="collapse" data-parent="#menu-group-1" class="" href="#sub-item-1">
                            ...
                            <span class="lbl">Doc.</span>
                        </a>
                        <ul class="children nav-child unstyled small collapse" id="sub-item-1">
                            <li class="item-2 deeper parent">
                                <div class="row" style="overflow-y: auto; height: 410px; margin-top: -5px; margin: 0">
                                    <% foreach (var documento in Lista)
                                        {%>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                        <div class="offer offer-radius <%=documento.CodigoClass%>">
                                            <div class="shape">
                            ...
                            <a href="documentos/<%=documento.Archivo%>">
                                <img src="img/<%=documento.TipoArchivo%>.png" />&nbsp;enlace_pdf</a>
    ...
    <script type="text/javascript">  
        ...
        window.onload = function () {
            if (window.innerWidth < 1148) {
                //document.getElementById("liDocu").style.background = '#E8E8E8';
                ...
                document.getElementById("idSubMenuDocume").style.fontWeight = "700";
                ...
                document.getElementById("idSubMenuDocume").style.color = 'white';
                document.getElementById("idSubMenuDocume").style.fontWeight = "700";
            }
        }
