<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="GenerarPeriodo.aspx.cs" Inherits="SantaNaturaNetworkV3.GenerarPeriodo" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">Periodos</h1>
    </section>
    <style>
        .ui-front {
    ...
    <section class="content">
        ...
        <script src="js/GenerarPeriodo.js" type="text/javascript"></script>
        <script type="text/javascript">
            window.onload = function () {
                ...
                document.getElementById("genePeri").style.color = '#79B729';
                document.getElementById("genePeri").style.textShadow = '0px 0px 4px rgbA(229, 246, 27, 0.8)';
            }
        </script>
    </section>
</asp:Content>
