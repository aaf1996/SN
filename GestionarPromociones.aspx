<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="GestionarPromociones.aspx.cs" Inherits="SantaNaturaNetworkV3.GestionarPromociones" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">Gestionar Anuncio de Promociones</h1>
    </section>
    <section class="content">
        ...
        <script src="js/GestionarPromocionesPDF.js?v6"></script>
        <script type="text/javascript">
            window.onload = function () {
                ...
                document.getElementById("gestPDFProm").style.color = '#79B729';
                document.getElementById("gestPDFProm").style.textShadow = '0px 0px 4px rgbA(229, 246, 27, 0.8)';
            }
        </script>
    </section>
</asp:Content>
