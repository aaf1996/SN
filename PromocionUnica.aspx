<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PromocionUnica.aspx.cs" Inherits="SantaNaturaNetworkV3.PromocionUnica" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1 style="text-align: center">Promoción Única</h1>
    </section>
    <style>
        .ui-front {
    ...
    <section class="content">
                                        ...
                                        <div class="container modal-dialog" id="modalTamano" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 style="text-align: center; font-weight: bold" class="modal-title" id="exampleModalLabel">Nueva Promocion</h4>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtNombreProducto" CssClass="form-control" BackColor="LightGreen"/>
                                                        </div>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtCantidad" CssClass="form-control" BackColor="LightGreen"/>
                                                        </div>
                                                    </div>
        ...
        <script src="js/GenerarPromocionUnica.js" type="text/javascript"></script>
        ...
        <script>
            window.onload = function () {
                ...
                document.getElementById("promUnica").style.color = '#79B729';
                document.getElementById("promUnica").style.textShadow = '0px 0px 4px rgbA(229, 246, 27, 0.8)';
            }
        </script>
