...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        //$('.pass_show').append('<span class="ptxt" style="cursor: pointer; margin-left: 15px; color: midnightblue;">mostrar</span>');
...
function toggleShowPassword() {
    const passwordField = document.getElementById("LoginUser_Password");
    //const passwordField2 = document.getElementById("LoginUser_Password2");
