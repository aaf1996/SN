...
(function (h) {
    ...
    function Va(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti
            ? ((c = h.inArray(b, F(e, "0"))), -1 !== c ? ((b = g(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = f[b]), (e[c]._idx = b))) : (e.push([b, f[0], 0]), (e[e.length - 1]._idx = 0)))
            : e.length && e[0][0] == b
    ...
    function Aa(a, b) {
        ...
        b <= c
            ...
            : a <= d
                ...
                : (a >= b - 1 - d ? (c = X(b - (c - 2), b)) : ((c = X(a - d + 2, a + d - 1)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
        c.DT_el = "span";
        return c;
    }
    function db(a) {
        ...
        return this.iterator("column", function (c, d) {
            ...
            if (a !== k && f.bVisible !== a) {
                if (a) {
                    ...
                    j = 0;
                    for (i = g.length; j < i; j++) (n = g[j].nTr), (e = g[j].anCells), n && n.insertBefore(e[d], e[l] || null);
